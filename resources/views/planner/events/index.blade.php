...
<div class="planner-events-page">
        ...
        <div class="kanban-board-supreme">
            ...
            <div class="kanban-column" data-status="pending">
                <div class="kanban-column-header pending">
                    ...
                    <span class="column-count">{{ $events->where('status', 'pending')->count() }}</span>
                </div>
                
                <div class="kanban-cards-container" id="pending-container">
                    @foreach($events->where('status', 'pending') as $event)
    ...
    <div class="view-container" id="calendarView" style="display: none;">
        <div class="calendar-heatmap-container">
            ...
            <div id="calendarGrid" class="calendar-grid-luxury">
                {{-- Generated by JS --}}
            </div>
...
<div class="quick-actions-fab" id="quickActionsFab">
    ...
    <div class="fab-menu">
        <button class="fab-action-btn" data-action="accept-all">
