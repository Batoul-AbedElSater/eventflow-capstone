...
<div class="settings-shell">
    <div class="settings-grid">
        ...
        <section class="settings-card settings-card-panel settings-card-notification">
            ...
            <p class="panel-copy">Enable or disable assistant notifications instantly. The system saves your choice and rolls back the switch if the update fails.</p>
        </section>
        ...
        <section class="settings-card settings-card-panel settings-card-actions">
            ...
            <p class="panel-copy">Sign out securely or permanently delete your assistant
...
<script>
    (function(){
        ...
        document.getElementById('deleteAccountBtn').addEventListener('click', async ()=>{
            ...
            if(!password) return;
            try{
                const res = await fetch('{{ route("assistant.settings.delete") }}', {
